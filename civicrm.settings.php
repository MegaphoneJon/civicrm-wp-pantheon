...
if (!empty($_SERVER['PRESSFLOW_SETTINGS'])) {
  $env = preg_replace('/\\\"/',"\"", $_SERVER['PRESSFLOW_SETTINGS']);
...
if (isset($pantheon_conf)) {
  $civicrm_root = '/srv/bindings/' . $pantheon_conf['pantheon_binding'] . '/code/wp-content/plugins/civicrm/civicrm/';
}
else {
...
if (isset($pantheon_conf)) {
  ...
  $civicrm_paths['civicrm.private']['url'] = CIVICRM_UF_BASEURL . 'wp-content/uploads/private/civicrm/';
} else {
...
if (isset($pantheon_conf)) {
  ...
  $civicrm_setting['Directory Preferences']['extensionsDir'] = '[cms.root]/wp-content/civicrm-custom/extensions/';

  // Override the Extensions Resource URL
  $civicrm_setting['URL Preferences']['extensionsURL'] = '[cms.root]/wp-content/civicrm-custom/extensions';
...
if (isset($pantheon_conf)) {
  ...
  $civicrm_setting['Directory Preferences']['customTemplateDir'] = '[cms.root]/wp-content/civicrm-custom/civicrm_custom/custom_templates/';

  // Override the Custom PHP directory
  $civicrm_setting['Directory Preferences']['customPHPPathDir'] = '[cms.root]/wp-content/civicrm-custom/civicrm_custom/custom_php/';
} else {
  // Override the Custom Templates directory
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', %%YOUR_SITE_KEY_HERE%);
}
